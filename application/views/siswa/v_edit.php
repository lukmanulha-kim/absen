        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4 border-bottom-primary">
            ...
            <div class="card-body">
              <div class="row">
              	<div class="col-md-6">
	              <form action="<?php echo base_url('index.php/siswa/update') ?>" method="post" accept-charset="utf-8">
	                ...
	                <div class="form-group">
	                  <b>NIS</b>
	                  <input type="text" name="i_nis" value="<?php echo $detail->nis ?>" class="form-control" readonly>
	                </div>
	                <div class="form-group">
	                  <b>NISN</b>
	                  <input type="text" name="i_nisn" value="<?php echo $detail->nisn ?>" class="form-control">
	                </div>
	                <div class="form-group">
	                  <b>Nama Siswa</b>
	                  <input type="text" name="i_namasiswa" value="<?php echo $detail->nama_siswa ?>" class="form-control">
	                </div>
	                <div class="form-group">
