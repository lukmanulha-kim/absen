              ...
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td><?php echo $no++ ?></td>
                      <td><a href="<?php echo base_url() ?>index.php/kehadiran/lihat_absen/<?php echo encrypt_url($data_rombel->id_kelas) ?>"><?php echo $data_rombel->nama_kelas; ?></a></td>
                      ...
                      <td>
                        <center>
                          ...
                          ?>
                             <a href="<?php echo base_url() ?>index.php/kehadiran/absen/<?php echo encrypt_url($data_rombel->id_rombel) ?>" title="Absen" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i> Isi Absensi</a>
                          <?php }else{ ?>
                          ...
                          <?php } ?>
                          <a href="<?php echo base_url() ?>index.php/kehadiran/rekap_absen/<?php echo encrypt_url($data_rombel->id_rombel) ?>" title="Rekap" class="btn btn-sm btn-success"><i class="fas fa-chart-area"></i> Rekap Absensi</a>
                        </center>
                      </td>
                    </tr>
                	<?php } ?>
